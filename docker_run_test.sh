...
# sudo rm -rf ${DOCKER_VOLUMES}/docker_temp_test
sudo mkdir -p ${DOCKER_VOLUMES}/docker_temp_test/develop/data
sudo mkdir -p ${DOCKER_VOLUMES}/docker_temp_test/develop/home
sudo mkdir -p ${DOCKER_VOLUMES}/docker_public//ssh_id_rsa
...
sudo docker run -d \
    -p $PORT_1:22 \
    -v ${DOCKER_VOLUMES}/docker_temp_test/ubuntu-base-flat/data:/data \
    -v ${DOCKER_VOLUMES}/docker_public/ssh_id_rsa:/ssh_id_rsa \
    --name docker_temp_test \
    --network work  \
